...
namespace Blauhaus.MVVM.Tests.Tests.ObservableIdCollectionTests
{
    ...
    public class UpdateAsyncLongTests : BaseMvvmTest<ObservableIdCollection<UpdateAsyncLongTests.IOutputObject, long>>
    {
        ...
        {
            //Act
            await Sut.UpdateAsync(new long[] {1, 2, 3});
        ...
        public async Task WHEN_items_exist_already_SHOULD_only_add_new_ones_in_correct_place()
        {
            ...
            await Sut.UpdateAsync(new long[] { 2 });
        ...
        public async Task WHEN_item_is_removed_SHOULD_remove_item()
        {
            ...
            //Act
            await Sut.UpdateAsync(new long[] {1, 3});
        ...
        public async Task WHEN_items_change_position_SHOULD_reorder()
        {
            ...
            await Sut.UpdateAsync(new long[] {2, 1, 3});

            //Act
            await Sut.UpdateAsync(new long[] {3, 1, 2});
